...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("TokenUser")));
bytes32 constant TokenUserTableId = _tableId;
...
library TokenUser {
  ...
  /** Get owner */
  function get(address ka) internal view returns (address owner) {
  ...
  function get(IStore _store, address ka) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  /** Set owner */
  function set(address ka, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function set(IStore _store, address ka, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
