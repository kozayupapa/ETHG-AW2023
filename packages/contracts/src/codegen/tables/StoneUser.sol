...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("StoneUser")));
bytes32 constant StoneUserTableId = _tableId;
...
library StoneUser {
  ...
  /** Get owner */
  function get(int32 xk, int32 yk) internal view returns (address owner) {
  ...
  function get(IStore _store, int32 xk, int32 yk) internal view returns (address owner) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  /** Set owner */
  function set(int32 xk, int32 yk, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  function set(IStore _store, int32 xk, int32 yk, address owner) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
