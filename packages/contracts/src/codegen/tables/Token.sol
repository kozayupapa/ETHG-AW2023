...
library Token {
  ...
  /** Get adr */
  function getAdr(address ka) internal view returns (address adr) {
  ...
  /** Get adr (using the specified store) */
  function getAdr(IStore _store, address ka) internal view returns (address adr) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  /** Set adr */
  function setAdr(address ka, address adr) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));

    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((adr)));
  }

  /** Set adr (using the specified store) */
  function setAdr(IStore _store, address ka, address adr) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));

    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((adr)));
  }

  /** Get name */
  function getName(address ka) internal view returns (string memory name) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function getName(IStore _store, address ka) internal view returns (string memory name) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  /** Set name */
  function setName(address ka, string memory name) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function setName(IStore _store, address ka, string memory name) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function lengthName(address ka) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function lengthName(IStore _store, address ka) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function getItemName(address ka, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function getItemName(IStore _store, address ka, uint256 _index) internal view returns (string memory) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function pushName(address ka, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function pushName(IStore _store, address ka, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function popName(address ka) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function popName(IStore _store, address ka) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function updateName(address ka, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function updateName(IStore _store, address ka, uint256 _index, string memory _slice) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function get(IStore _store, address ka) internal view returns (TokenData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((ka))));
  ...
  function decode(bytes memory _blob) internal view returns (TokenData memory _table) {
    ...
    _table.adr = (address(Bytes.slice20(_blob, 0)));
