...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("StoneToken")));
bytes32 constant StoneTokenTableId = _tableId;
...
library StoneToken {
  ...
  /** Get token */
  function get(int32 xk, int32 yk) internal view returns (address token) {
  ...
  function get(IStore _store, int32 xk, int32 yk) internal view returns (address token) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  /** Set token */
  function set(int32 xk, int32 yk, address token) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  function set(IStore _store, int32 xk, int32 yk, address token) internal {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  function encode(address token) internal view returns (bytes memory) {
