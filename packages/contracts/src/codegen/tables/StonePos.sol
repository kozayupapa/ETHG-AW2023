...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("StonePos")));
bytes32 constant StonePosTableId = _tableId;
...
library StonePos {
  ...
  /** Get the full data */
  function get(int32 xk, int32 yk) internal view returns (StonePosData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  function get(IStore _store, int32 xk, int32 yk) internal view returns (StonePosData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](2);
    _keyTuple[0] = bytes32(uint256(uint32((xk))));
    _keyTuple[1] = bytes32(uint256(uint32((yk))));
  ...
  function set(int32 xk, int32 yk, int32 x, int32 y) internal {
  ...
  function set(IStore _store, int32 xk, int32 yk, int32 x, int32 y) internal {
    bytes memory _data = encode(x, y);
  ...
  function set(int32 xk, int32 yk, StonePosData memory _table) internal {
    set(xk, yk, _table.x, _table.y);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, int32 xk, int32 yk, StonePosData memory _table) internal {
    set(_store, xk, yk, _table.x, _table.y);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal pure returns (StonePosData memory _table) {
