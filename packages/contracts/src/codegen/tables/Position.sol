...
library Position {
  ...
  function getX(IStore _store, address player) internal view returns (int32 x) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((player))));
  ...
  function setX(IStore _store, address player, int32 x) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((player))));
  ...
  function getY(IStore _store, address player) internal view returns (int32 y) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((player))));
  ...
  function setY(IStore _store, address player, int32 y) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((player))));
  ...
  function get(IStore _store, address player) internal view returns (PositionData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = bytes32(uint256(uint160((player))));
  ...
  function set(IStore _store, address player, int32 x, int32 y) internal {
    bytes memory _data = encode(x, y);
  ...
  function set(address player, PositionData memory _table) internal {
    set(player, _table.x, _table.y);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, address player, PositionData memory _table) internal {
    set(_store, player, _table.x, _table.y);
  }
